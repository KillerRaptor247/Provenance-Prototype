...
export declare const applyActionFunction: <T, S, A>(_graph: ProvenanceGraph<S, A>, actionFn: ApplyObject<T, S>, currentState: T, serialize: Serializer<T>, customLabel?: string | undefined) => import("../Types/Nodes").ProvenanceNode<S, A>;
