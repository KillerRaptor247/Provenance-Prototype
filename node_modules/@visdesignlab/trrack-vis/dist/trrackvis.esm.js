...
import { stratify, symbol, symbolStar, symbolDiamond, symbolTriangle, symbolCircle, symbolCross, symbolSquare, symbolWye } from 'd3';
...
function BackboneNode(_ref) {
  ...
  var _useState = useState(((_prov$getLatestAnnota = prov.getLatestAnnotation(node.id)) == null ? void 0 : _prov$getLatestAnnota.annotation) ? (_prov$getLatestAnnota2 = prov.getLatestAnnotation(node.id)) == null ? void 0 : _prov$getLatestAnnota2.annotation : ''),
  ...
  var glyph = React.createElement("circle", {
    style: cursorStyle,
  ...
  var labelG = React.createElement("g", {
    style: {
      opacity: 1
    },
    transform: translate(padding, 0)
  }, !iconOnly ? React.createElement("g", null, dropDownAdded ? React.createElement("text", {
    style: cursorStyle,
    ...
    y: 0,
    fontFamily: "Icons"
  }, expandedClusterList && expandedClusterList.includes(node.id) ? "\uF0D8" : "\uF0D7") : React.createElement("g", null), editAnnotations ? React.createElement("button", null, React.createElement("i", {
    className: "fas fa-undo marginRight"
  }), "Undo") : React.createElement("g", null), React.createElement("text", {
  ...
  }, annotate), ",", React.createElement("text", {
    style: cursorStyle,
    onClick: function onClick(e) {
    ...
    y: 0,
    fontFamily: "Icons"
  }, "\uF044")) : React.createElement("g", null, dropDownAdded ? React.createElement("text", {
    style: cursorStyle,
    onClick: function onClick(e) {
      return nodeClicked(node, e);
    },
    ...
    y: 0,
    fontFamily: "Icons"
  }, expandedClusterList && expandedClusterList.includes(node.id) ? "\uF0D8" : "\uF0D7") : React.createElement("g", null)));
  return React.createElement(Animate, {
    ...
    return React.createElement(React.Fragment, null, popupContent !== undefined && nodeMap[node.id].depth > 0 ? React.createElement(Popup, {
      content: popupContent(node),
      trigger: glyph
    }) : glyph, popupContent !== undefined && nodeMap[node.id].depth > 0 ? React.createElement(Popup, {
      content: popupContent(node),
      trigger: labelG
    }) : labelG, annotationOpen !== -1 && nodeMap[node.id].depth === annotationOpen ? React.createElement("g", {
      ...
      onClick: handleCheck
    }, "Annotate"), React.createElement("button", {
      onClick: handleClose
...
function BookmarkNode(_ref) {
  ...
  return React.createElement(Animate, {
    ...
    }, glyph, React.createElement("text", {
      y: 0,
      x: 20,
      dominantBaseline: "middle",
      textAnchor: "start",
...
function BookmarkListView(_ref) {
  ...
  return React.createElement(NodeGroup, Object.assign({
    data: bookmarks,
    keyAccessor: function keyAccessor(d) {
      return d.label;
    }
  }, BookmarkTransitions(xOffset, yOffset, bookmarks)), function (innerBookmarks) {
    return React.createElement(React.Fragment, null, innerBookmarks.map(function (bookmark) {
      var d = bookmark.data,
          key = bookmark.key,
      ...
      }, React.createElement(BookmarkNode, {
...
var undoButtonStyle = /*#__PURE__*/style({
  marginTop: '2px',
  borderRadius: '2px',
...
var redoButtonStyle = /*#__PURE__*/style({
  marginTop: '2px',
  borderRadius: '2px',
  display: 'inline-block',
  cursor: 'pointer',
...
function ProvVis(_ref) {
  ...
  function setDefaultConfig(types) {
    var symbols = [symbol().type(symbolStar).size(50), symbol().type(symbolDiamond), symbol().type(symbolTriangle), symbol().type(symbolCircle), symbol().type(symbolCross), symbol().type(symbolSquare), symbol().type(symbolWye)]; // Find nodes in the clusters whose entire cluster is on the backbone.
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(types), _step; !(_step = _iterator()).done;) {
      var _j = _step.value;
      conf[_j] = {};
      conf[_j].backboneGlyph = React.createElement("path", {
        strokeWidth: 2,
        className: treeColor(false),
        d: symbols[counter]()
      });
      conf[_j].bundleGlyph = React.createElement("path", {
        strokeWidth: 2,
        className: treeColor(false),
        d: symbols[counter]()
      });
      conf[_j].currentGlyph = React.createElement("path", {
        strokeWidth: 2,
        className: treeColor(true),
        d: symbols[counter]()
      });
      conf[_j].regularGlyph = React.createElement("path", {
        strokeWidth: 2,
        className: treeColor(false),
        d: symbols[counter]()
      });
  ...
  var _useState5 = useState(Object.keys(bundleMap)),
  ...
  var strat = stratify().id(function (d) {
    return d.id;
  }).parentId(function (d) {
  ...
  var bookmarkTabView = React.createElement("svg", {
    style: {
      overflow: 'visible'
    },
  ...
  var graphTabView = React.createElement("div", null, React.createElement("div", {
    id: "undoRedoDiv"
  }, React.createElement(UndoRedoButton, {
    graph: prov ? prov.graph : undefined,
    ...
    id: 'globalG',
    transform: translate(shiftLeft, topOffset)
  }, React.createElement(NodeGroup, Object.assign({
    data: links,
    ...
    return React.createElement(React.Fragment, null, linkArr.map(function (link) {
      var key = link.key,
          state = link.state;
      return React.createElement("g", {
        key: key
      }, React.createElement(Link, Object.assign({}, state, {
        fill: '#ccc',
        stroke: '#ccc',
    ...
    return React.createElement(React.Fragment, null, nodes.map(function (node) {
      var d = node.data,
          key = node.key,
          state = node.state;
      var popupTrigger = React.createElement("g", {
        key: key,
        onClick: function onClick() {
          if (changeCurrent) {
            changeCurrent(d.id);
      ...
      }, d.width === 0 && prov ? React.createElement("g", null, React.createElement("rect", {
        width: "200",
        height: "25",
        transform: "translate(0, -12.5)",
        opacity: "0"
      }), ",", React.createElement(BackboneNode, {
        prov: prov,
        textSize: textSize,
        iconOnly: iconOnly,
      ...
      })) : popupContent !== undefined ? React.createElement(Popup, {
        content: popupContent(d.data),
        trigger: React.createElement("g", {
          onClick: function onClick() {
            setAnnotationOpen(-1);
          }
    ...
    return React.createElement(React.Fragment, null, bundle.map(function (b) {
      var key = b.key,
          state = b.state;
...
function ProvVisCreator(node, prov, callback, buttons, ephemeralUndo, fauxRoot, config) {
  ...
  prov.addGlobalObserver(function () {
    ReactDOM.render(React.createElement(ProvVis, Object.assign({}, config, {
      root: fauxRoot,
...
function UndoRedoButtonCreator(node, graph, undoCallback, redoCallback) {
  ReactDOM.render(React.createElement(UndoRedoButton, {
    graph: graph,
...
export { ProvVis, ProvVisCreator, UndoRedoButtonCreator };
//# sourceMappingURL=trrackvis.esm.js.map
