(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@visdesignlab/trrack'), require('d3'), require('react'), require('react-move'), require('semantic-ui-react'), require('typestyle'), require('mobx'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', '@visdesignlab/trrack', 'd3', 'react', 'react-move', 'semantic-ui-react', 'typestyle', 'mobx', 'react-dom'], factory) :
  (global = global || self, factory(global.trrackvis = {}, global.trrack, global.d3, global.React, global.ReactMove, global.semanticUIReact, global.typestyle, global.mobx, global.ReactDOM));
}(this, (function (exports, trrack, d3, React, reactMove, semanticUiReact, typestyle, mobx, ReactDOM) { 'use strict';
...
//# sourceMappingURL=trrackvis.umd.development.js.map
